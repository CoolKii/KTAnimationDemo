...
#import "KTAnimation_position.h"

@interface KTAnimation_position ()

@property (nonatomic , strong) UIImageView *wsView;

@end

@implementation KTAnimation_position
...
- (void)btnAction:(UIButton *)btn {
    ...
    switch (btn.tag) {
        ...
        case 4:
        {
            ...
            anima.delegate = (id)self;//设置代理，可以检测动画的开始和结束
